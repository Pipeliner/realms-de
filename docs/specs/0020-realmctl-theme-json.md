...
- **Decisions:** [SPEC 0006](0006-realm-ctl.md), [SPEC 0011](0011-theme-activation-generations.md)
- **Supersedes / Superseded by:** —

## Purpose

Make `realmctl theme lint --json` and `realmctl theme diff --json` safe for
