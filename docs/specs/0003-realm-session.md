...
locked state in report order, emits one `BindingRepeatStopped` for each binding
it had reported pressed and clears that held set. In the response to the
