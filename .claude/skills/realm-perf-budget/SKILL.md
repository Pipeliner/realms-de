...
| `realmctl theme apply` | **< 150 ms** | one captured input set is rendered, validated, sealed, made durable, and selected as an immutable generation for future launches; no pointer-switch reload |
