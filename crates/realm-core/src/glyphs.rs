...
//!
//! realm draws runes, planetary symbols, braille sparklines and one Egyptian
...
/// One glyph realm intends to draw.
...
/// Every glyph realm draws, with its documented fallback.
pub fn inventory() -> Vec<Glyph> {
    ...
    let mut v = vec![
        ...
        // workspace. realm falls back to digits and says so loudly.
...
pub struct Probe {
    ...
    /// Glyphs it cannot, which realm will substitute.
