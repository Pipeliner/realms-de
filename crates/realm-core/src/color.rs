...
//!
//! realm derives its contrast variants perceptually instead of slapping a
...
impl Oklab {
    ...
    /// realm's violet bright enough and naive clamping drifts it toward blue.
...
/// numerical noise — realm stops pushing at the gamut boundary. The accent gets
