...
//!
//! realm binds everything under one modifier. The bar shows the current mode and
...
/// Everything a keybinding can ask realm to do.
    ...
    fn default() -> Self {
        let mut bindings = vec![
            ...
            b(
                ...
                "b",
                "hermes",
                Action::Spawn(vec!["realm-browser".into()]),
                true,
            ),
