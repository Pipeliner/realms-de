//! Shared contracts for the realm desktop environment.
//!
...
/// Errors produced while loading or validating realm configuration.
...
/// Convenience alias used throughout realm.
