...
//!
//! 1. **Templates address the derived palette.** [`realm_core::Palette::derived`]
...
pub use theme::{
    apply, apply_with_snapshot, diff, diff_with_snapshot, ensure_current, lint, load_lint_palette,
    load_palette, HueSeparation, LintReport, ThemeOutputChange, ThemeSnapshot, SHIPPED_PALETTE,
    USER_PALETTE,
};
...
pub enum Error {
    ...
    PaletteRefused(Vec<realm_core::palette::Finding>),
